...
public class SinglePassTypeCheck implements Visitor<Context,Object>{
    ...
    public Object visitCallStmt(CallStmt stmt, Context arg) {
        ...
        for (Expression e: stmt.argList) {
            e.visit(this, nextArg);
            System.out.println(nextArg.GetType());
        }
        return null;
    }
    ...
    private void SetTypeDecl(Context arg, Declaration decl) {
        ...
        {
            arg.SetMethodDec((MethodDecl)decl);
        }
