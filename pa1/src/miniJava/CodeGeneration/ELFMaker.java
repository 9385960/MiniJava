...
public class ELFMaker {
	...
	public ELFMaker(ErrorReporter errors, long textSize, long bssSize) {
		...
		shstrtab.sh_type = 0x00; // TODO: what is the type of the shstrtab section?
		shstrtab.sh_flags = 0x00; // TODO: what are the flags of this section?
	...
	public void outputELF(String fname, byte[] textSection, long entrypoint) {
		...
		phdr.p_type = 0x00; // TODO: what is the type of the program header segment?
		phdr.p_flags = 0x00; // TODO: what are the flags of the program header segment?
		...
		textSeg.p_type = 0x00; // TODO: type of the text segment?
		textSeg.p_flags = 0x00; // TODO: flags for the text segment?
